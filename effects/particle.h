...
#include <DirectXMath.h>
 ...
 // TODO: インスタンシング / GPUパーティクル / ジオメトリシェーダ

/**
 * @brief パーティクル基底クラス
 *
 * 位置・速度・寿命を管理する。
 * 派生クラスでUpdate/Drawをオーバーライドして具体的な挙動を実装する。
 */
class Particle {
private:
...
/**
 * @brief パーティクルエミッター基底クラス
 *
 * パーティクルの生成・更新・破棄を管理する。
 * 派生クラスでCreateParticle()をオーバーライドして
 * 具体的なパーティクルを生成する。
 */
class Emitter {
private:
