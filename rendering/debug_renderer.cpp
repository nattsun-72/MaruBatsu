...
{
    // --- デバッグ描画の定数 ---
    constexpr int MAX_DEBUG_VERTICES = 20000;  // 頂点バッファの最大頂点数
    constexpr int SPHERE_SEGMENTS = 16;        // 球体描画の分割数
    ...
    void Initialize()
    {
        ...
        bd.ByteWidth = sizeof(DebugVertex) * MAX_DEBUG_VERTICES; // 容量を少し増やして2万頂点
    ...
    void Render(const XMFLOAT4X4& view, const XMFLOAT4X4& proj)
    {
        ...
        if (drawCount > MAX_DEBUG_VERTICES) drawCount = MAX_DEBUG_VERTICES;
